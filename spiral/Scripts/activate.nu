...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\crodi\PycharmProjects\AI_agent\spiral'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\crodi\PycharmProjects\AI_agent\spiral\Scripts\deactivate.nu'
